...
## 8. V1 Endpoint Boundary (Frozen)

V1 mobile integration is limited to these route groups:

- /api/users/me/
- /api/users/service-points/
...
Deferred to V1.1+ unless mandatory for pilot stability:

- payment-runs
- order status override and void flows
- guest visit workflows
- folio charging workflows
- transaction history enhancements
- advanced room and reservation workflows
- non-essential setup/admin endpoints

Change rule:

Any endpoint outside this boundary needs a documented RFC entry with business reason, risk, and impact on pilot date.
