...
const routeLabels = {
  '/inventory': 'Inventory',
  '/inventory/products': 'Products & Items',
        ...
        <div className="flex h-20 items-center justify-between border-b border-shell-border px-5 sm:px-8">
          <Link to="/home" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-[10px] font-bold uppercase tracking-[0.18em] text-shell-muted">Inventory App</p>
            </div>
          </Link>
        ...
        <div className="border-t border-shell-border bg-shell-elevated p-6">
          <div className="flex items-center justify-between rounded-2xl border border-shell-border bg-shell-bg p-3">
            <div className="min-w-0">
              <p className="truncate text-sm font-black text-shell-text">{profile.userName || 'Inventory user'}</p>
              <p className="text-[10px] font-bold uppercase tracking-tight text-shell-muted">Stock workspace</p>
            </div>
          ...
          <div className="px-4 py-4 sm:px-6 lg:px-8 lg:py-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="hidden text-sm text-shell-muted sm:block">Categories, products, purchase prices, sales prices, and stock workflow</p>
              </div>
