      ...
      <section className="relative min-h-[52svh] overflow-hidden bg-ink text-white lg:min-h-[62svh]">
        ...
        <div className="page-shell relative flex min-h-[52svh] items-end pb-9 pt-20 lg:min-h-[62svh] lg:items-center lg:pb-12">
          <div className="max-w-2xl">
            ...
            <h1 className="mt-3 text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl">Give your team room to think differently.</h1>
            ...
            <div className="mt-5 max-w-md rounded-2xl border border-white/15 bg-white/10 p-3 backdrop-blur">
