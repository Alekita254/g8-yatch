...
urlpatterns = [
    ...
    path("visits/<int:pk>/invoice/", GuestVisitInvoiceDocumentView.as_view(), name="guest-visit-invoice"),
    path("visits/<int:pk>/receipt/", GuestVisitReceiptDocumentView.as_view(), name="guest-visit-receipt"),
    ...
    path("orders/<int:pk>/receipts/", SalesOrderReceiptsView.as_view(), name="sales-order-receipts"),
    ...
    path("invoices/<int:pk>/invoice/", SalesInvoiceDocumentView.as_view(), name="sales-invoice-document"),
